...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="POST" >
            ...
            <input type="password" placeholder="Enter new password" name="password" value="<?php echo $row['password'] ?>" required>
            <input type="file" placeholder="Mobile Number" name="img" value="<?php echo $row['img'] ?>" required>
        ...
        <?php
            if(isset($_POST['update']))
            {
                ...
                $query = "UPDATE users SET fname = '$Username', sname = '$Surname', role = '$Role', email = '$email', joining_date = '$Joining_date',gender='$Gender',address1='$Address', mobileno='$Mobileno', password='$Password', img='$Image1' WHERE unique_id='$Id'";
                $query_run = mysqli_query($connection,$query);
                ...
                else
                {
                    ...
                    window.location.href = 'updateuser1.php';
                    </script>";
                }
            }
