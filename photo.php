...
<input type="checkbox" id="check">
    ...
    <div class="sidebar">
      ...
      <a href="users.php" ><i class="fas fa-file-invoice-dollar"></i><span>Chat with colligues</span></a>
    ...
    <div class="main">
      ...
      <?php if (isset($_GET['error'])):?>
        ...
        <form action="picadd.php" method="POST" enctype="" style="padding-left: 383px;">
